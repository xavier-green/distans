...
export default class EditUser extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      bday: this.props.user.userObject.bday || null,
  ...
  save() {
    let { bday,sex } = this.state;
    this.props.dispatch(actions.editPsy(this.props.user.email, bday, sex));
    ...
    return (
      ...
      <Card style={{marginTop:'25px'}}>
        ...
        <div style={{display:'flex'}}>
          ...
          <DatePicker 
            hintText={
              this.props.user.userObject.bday == null ?
              "Choisissez votre date de naissance" :
              this.props.user.userObject.bday
            }
