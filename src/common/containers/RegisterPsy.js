...
const items = [
  <MenuItem key={1} value="Clinicien" primaryText="Psychologue clinicien"/>,
  <MenuItem key={2} value="Psychothérapeutes" primaryText="Psychothérapeutes"/>,
  <MenuItem key={3} value="Education" primaryText="Psychologues de l’éducation"/>,
  <MenuItem key={4} value="Neuropsychologues" primaryText="Neuropsychologues"/>,
  <MenuItem key={5} value="Sociaux" primaryText="Psychologues sociaux"/>,
  <MenuItem key={6} value="Travail" primaryText="Psychologues du travail"/>,
  <MenuItem key={7} value="Criminologues" primaryText="Psychologues criminologues"/>,
  <MenuItem key={8} value="Sportifs" primaryText="Psychologues sportifs"/>,
  <MenuItem key={9} value="sexologues" primaryText="Sexologues"/>,
  <MenuItem key={10} value="autre" primaryText="Autre"/>,
];
...
class Contact extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div>
      <CardTitle style={{textAlign:'center'}} title="Information Supplémentaire" subtitle="Ces informations sont nécessaires pour permettre de mieux cibler vos patients. De cette manière nous voulons maximiser votre expérience à tous deux." />
      <GridList cols={2}>
        <GridTile key={1}>
          <CardText>
...
class Docs extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div>
      <CardTitle style={{textAlign:'center'}} title="Pièces à joindre" subtitle="Veuillez ajouter une photocopie de votre passeport / carte d'identité et certificat ADELI pour finaliser l'inscription." />
      <CardText>
...
class Register extends React.Component {
  ...
  render() {
    ...
    var items = [
      ...
      <Contact _handleCheckChange={::this._handleCheckChange} videoconf={this.state.videoconf} _handleChange={::this._handleChange} region={this.state.region} psy={this.state.psy} _regionChange={::this._regionChange} _selectChange={::this._selectChange} _dateChange={::this._dateChange} bday={this.state.bday} />,
